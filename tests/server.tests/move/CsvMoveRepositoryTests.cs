...
public class CsvMoveRepositoryTests
{
    ...
    */
    ...
    public static TheoryData<int, string, TargetType, AttackRange, int, ElementType> AttackMoveDefinitions => new()
    {
        ...
        { 102, "なぎはらい", TargetType.Enemy, AttackRange.AcrossRows, 4, ElementType.Slash },
        { 103, "スラッシュ", TargetType.Enemy, AttackRange.AcrossRows, 6, ElementType.Slash },
        { 104, "ギガスラッシュ", TargetType.Enemy, AttackRange.AcrossRows, 12, ElementType.Slash },
        { 105, "シールドバッシュ", TargetType.Enemy, AttackRange.Single, 5, ElementType.Strike },
        { 106, "ヴズルイフ", TargetType.Enemy, AttackRange.AcrossColumns, 6, ElementType.None },
        { 107, "ヒルフェ", TargetType.Enemy, AttackRange.Single, 5, ElementType.Holy },
        { 108, "プラーミア", TargetType.Enemy, AttackRange.AcrossColumns, 6, ElementType.Fire },
        ...
        { 113, "クラインヴォーダ", TargetType.Enemy, AttackRange.AcrossRows, 4, ElementType.Water },
        { 114, "ミッテルヴォーダ", TargetType.Enemy, AttackRange.AcrossRows, 7, ElementType.Water },
        { 115, "グロースヴォーダ", TargetType.Enemy, AttackRange.AcrossRows, 11, ElementType.Water },
        { 116, "ウアヴォーダ", TargetType.Enemy, AttackRange.AcrossRows, 17, ElementType.Water },
        ...
        { 121, "クラインゼムリャ", TargetType.Enemy, AttackRange.AcrossColumns, 4, ElementType.Earth },
        { 122, "ミッテルゼムリャ", TargetType.Enemy, AttackRange.AcrossColumns, 7, ElementType.Earth },
        { 123, "グロースゼムリャ", TargetType.Enemy, AttackRange.AcrossColumns, 11, ElementType.Earth },
        { 124, "ウアゼムリャ", TargetType.Enemy, AttackRange.AcrossColumns, 17, ElementType.Earth },
        { 138, "魔神斬り", TargetType.Enemy, AttackRange.Single, 8, ElementType.Slash },
        { 203, "フレアライン", TargetType.Enemy, AttackRange.AcrossRows, 9, ElementType.Fire },
    ...
    public static TheoryData<int, string, MoveCategory, TargetType, AttackRange> FamilyRepresentativeDefinitions => new()
    {
        ...
        { 102, "なぎはらい", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossRows },
        { 105, "シールドバッシュ", MoveCategory.Attack, TargetType.Enemy, AttackRange.Single },
        { 106, "ヴズルイフ", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossColumns },
        ...
        { 503, "ポイズンミスト", MoveCategory.Support, TargetType.Enemy, AttackRange.AcrossRows },
        ...
        { 108, "プラーミア", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossColumns },
        { 113, "クラインヴォーダ", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossRows },
        { 117, "クラインヴェーチェル", MoveCategory.Attack, TargetType.Enemy, AttackRange.Square },
        { 121, "クラインゼムリャ", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossColumns },
    ...
    public static TheoryData<int, string, AttackRange, AilmentType, int> AilmentMoveDefinitions => new()
    {
        ...
        { 503, "ポイズンミスト", AttackRange.AcrossRows, AilmentType.Poison, 1 },
