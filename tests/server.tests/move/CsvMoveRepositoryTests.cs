...
public class CsvMoveRepositoryTests
{
    ...
    */
    ...
    public static TheoryData<int, string, TargetType, AttackRange, int, ElementType> AttackMoveDefinitions => new()
    {
        ...
        { 108, "プラーミア", TargetType.Enemy, AttackRange.Single, 6, ElementType.Fire },
        ...
        { 113, "クラインヴォーダ", TargetType.Enemy, AttackRange.AcrossColumns, 4, ElementType.Water },
        { 114, "ミッテルヴォーダ", TargetType.Enemy, AttackRange.AcrossColumns, 7, ElementType.Water },
        { 115, "グロースヴォーダ", TargetType.Enemy, AttackRange.AcrossColumns, 11, ElementType.Water },
        { 116, "ウアヴォーダ", TargetType.Enemy, AttackRange.AcrossColumns, 17, ElementType.Water },
    ...
    public static TheoryData<int, string, MoveCategory, TargetType, AttackRange> FamilyRepresentativeDefinitions => new()
    {
        ...
        { 113, "クラインヴォーダ", MoveCategory.Attack, TargetType.Enemy, AttackRange.AcrossColumns },
