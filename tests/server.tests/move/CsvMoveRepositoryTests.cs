...
public class CsvMoveRepositoryTests
{
    ...
    */
    ...
    public static TheoryData<int, string, TargetType, AttackRange, int, ElementType> AttackMoveDefinitions => new()
    {
        ...
        { 113, "クラインヴォーダ", TargetType.Enemy, AttackRange.Row, 4, ElementType.Water },
        { 114, "ミッテルヴォーダ", TargetType.Enemy, AttackRange.Row, 7, ElementType.Water },
        { 115, "グロースヴォーダ", TargetType.Enemy, AttackRange.Row, 11, ElementType.Water },
        { 116, "ウアヴォーダ", TargetType.Enemy, AttackRange.Row, 17, ElementType.Water },
    ...
    public static TheoryData<int, string, MoveCategory, TargetType, AttackRange> FamilyRepresentativeDefinitions => new()
    {
        ...
        { 113, "クラインヴォーダ", MoveCategory.Attack, TargetType.Enemy, AttackRange.Row },
