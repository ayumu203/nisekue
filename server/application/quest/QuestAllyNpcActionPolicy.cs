...
public class QuestAllyNpcActionPolicy
{
        ...
        DateTimeOffset now)
    {
        ...
        return snapshot.Job switch
        {
            ...
            Job.Guardian or Job.Trickster or Job.Crusader or Job.GrandGuard or Job.GreatKnight or Job.Shugoshin => SelectGuardianAction(run, snapshot, state, orderedMoves, now),
