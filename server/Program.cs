...
builder.Services.AddScoped<IPetBattleRoomRepository, DbPetBattleRoomRepository>();
builder.Services.AddScoped<IPetBattleRunRepository, DbPetBattleRunRepository>();
builder.Services.AddScoped<IPlayerPetBattleStatsRepository, DbPlayerPetBattleStatsRepository>();
builder.Services.AddScoped<IMatchingCandidateRepository, DbMatchingCandidateRepository>();
