...
namespace server.infrastructure.migrations
{
    ...
    [Migration("20260614012237_AddPlayerRebirthStatusHistory")]
    partial class AddPlayerRebirthStatusHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.infrastructure.chat.ChatMessageAlertEntity", b =>
                {
                    ...
                    b.ToTable("chat_message_alerts", "internal");
                });
            ...
            modelBuilder.Entity("server.infrastructure.chat.ThreadReplyEntity", b =>
                {
                    ...
                    b.Property<bool>("IsAuthorAlerted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("server.infrastructure.player.PlayerRebirthStatusHistoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset>("RebirthedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("rebirthed_at");
                    ...
                    b.HasIndex("PlayerId", "RebirthCount")
                        .IsUnique();

                    b.ToTable("player_rebirth_status_histories", "internal");
                });
