...
{
    private readonly HashSet<Job> equippableJobs = equippableJobs is null ? [] : new HashSet<Job>(equippableJobs);
    ...
    public IReadOnlySet<Job> EquippableJobs => equippableJobs;

    public bool CanEquip(Job job) => equippableJobs.Contains(job);
}
